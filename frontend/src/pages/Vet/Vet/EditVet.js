...
useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    if(file ){
      ...
      userRequest.put("/vets/" + id, { vcslId, vetName, telephone, email, experience, qualification, profilePicture: URL },{headers: { "csrf-token": csrfToken }})
      .then(res => {
      ...
      userRequest.put("/vets/" + id, { vcslId, vetName, telephone, email, experience, qualification, profilePicture: imageURL },{headers: { "csrf-token": csrfToken }})
      .then(res => {
          toast.success('Vet updated')
          navigate('/admin/vets/manageVet')
      }).catch(err => {
