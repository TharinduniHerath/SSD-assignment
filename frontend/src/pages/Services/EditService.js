...
useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    if(file ){
      ...
      userRequest.put("/services/" + id, { serviceId,serviceName,serviceCharge,serviceDescription,serviceImage: URL },{headers: { "csrf-token": csrfToken }})
      .then(res => {
      ...
      userRequest.put("/services/" + id, { serviceId, serviceName, serviceCharge, serviceDescription, serviceImage: imageURL },{headers: { "csrf-token": csrfToken }})
      .then(res => {
          toast.success('Service updated')
          navigate('/admin/service/ManageServices')
      }).catch(err => {
