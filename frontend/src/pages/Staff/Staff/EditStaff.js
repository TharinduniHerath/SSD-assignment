...
useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    if(simage ){
      ...
      userRequest.put("/staff/" + id, { firstName, lastName, address, nic, contactNo, dob, email, department, designation, joinedDate, salary, simage : URL },{headers: { "csrf-token": csrfToken }})
      .then(res => {
      ...
      userRequest.put("/staff/" + id, {firstName, lastName, address, nic, contactNo, dob, email, department, designation, joinedDate, salary, simage : imageURL },{headers: { "csrf-token": csrfToken }})
      .then(res => {
          toast.success('Staff Deatils updated')
          navigate('/admin/staff/ManageStaff')
      }).catch(err => {
