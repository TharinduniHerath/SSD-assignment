...
useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    userRequest.post("/staff",  {firstName, lastName, address, nic, contactNo, dob, email, department,designation, joinedDate, salary, simage: imageURL},{headers: { "csrf-token": csrfToken }})
    .then(res => {
