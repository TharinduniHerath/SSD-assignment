...
useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    userRequest.post("/products", { productName, brand, categories: { categoryA: catA, categoryB: catB }, quantity, price, description, SKU, image: imageURL },{ headers: { "csrf-token": csrfToken } })
    .then(res => {
