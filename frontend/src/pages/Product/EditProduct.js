...
useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    if(file ){
      ...
      userRequest.put("/products/" + id, { productName, brand, categories: { categoryA: catA, categoryB: catB }, quantity, price, description, SKU, image: URL },{headers:{ "csrf-token": csrfToken }})
      .then(res => {
      ...
      userRequest.put("/products/" + id, { productName, brand, categories: { categoryA: catA, categoryB: catB }, quantity, price, description, SKU, image: imageURL },{headers:{ "csrf-token": csrfToken }})
      .then(res => {
          toast.success('Product updated')
          navigate('/admin/products/manageProducts')
      }).catch(err => {
